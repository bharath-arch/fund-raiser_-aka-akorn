      ...
      <section className="pl-16 pt-10 pr-16">
        ...
        <div className="flex flex-col gap-2 mt-3">
          ...
          <input
            ...
            placeholder="Email"
          />
          <label htmlFor="" className="font-semibold text-xl">LinkedIn URL (if any)</label>
          <input
            type="url"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Your Name"
          />
          <label htmlFor="" className="font-semibold text-xl">Address</label>
          <textarea
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Address"
          ></textarea>
          <label htmlFor="" className="font-semibold text-xl">PAN</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="PAN"
          />
          <label htmlFor="" className="font-semibold text-xl">Aadhar</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Aadhar"
          />
          <label htmlFor="" className="font-semibold text-xl">Contact Number</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Contact Number"
          />
          <label htmlFor="" className="font-semibold text-xl">Whats app Number</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Whats app Number"
          />
          <label htmlFor="" className="font-semibold text-xl">Describe about yourself</label>
          <textarea
          ...
          />
          <label htmlFor=""className="font-semibold text-xl">What is your annual income</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="annual income"
          />
          <label htmlFor="" className="font-semibold text-xl">Bank account Number</label>
          <input
            type="text"
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="account Number"
          />
          <label htmlFor="" className="font-semibold text-xl">Upload bank acc photo</label>
          <input
            type="file"
          ...
          />
          <label htmlFor="" className="font-semibold text-xl">From where you learn about us</label>
          <textarea
            className=" border-2 rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="From where you learn about us"
          />

          <label htmlFor="" className="font-semibold text-xl">Do you have any existing commitments?</label>
          ...
          <label htmlFor="" className="font-semibold text-xl">Upload your Image</label>
          <input
            type="file"
            className=" border-2 border-dashed rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
            placeholder="Upload your Image"
          />
          <label htmlFor="" className="font-semibold text-xl">Upload your ID proof</label>
          <input
            type="file"
            className=" border-2 border-dashed rounded-2xl w-[100%]  p-2  border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-500"
          ...
          <div className="flex justify-center mt-3 mb-3">
            <button
              ...
              onClick={() => toast.success("Success! Your KYC application has been submitted.")}
            >
              Submit
            </button>
          </div>
