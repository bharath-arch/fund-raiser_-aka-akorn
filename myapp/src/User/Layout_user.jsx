  ...
  return (
    <div className="">
      <div className="flex justify-between text-center items-center ml-8 mr-8 mt-3">
        <div className="">
          <span className="font-bold text-4xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">Akorn</span>
        </div>
        <div className="">
          <ul className="flex gap-5 font-semibold text-xl">
            ...
            <li
              ...
              className={`${
                selectLink === "id" ? "text-blue-900 p-2" : "p-2"
              }`}
            >
              <Link to={"id"}>ID</Link>
            </li>
        ...
        <div className="h-10 w-10 border-1 rounded-full bg-red-600 items-center text-center"></div>
      </div>
