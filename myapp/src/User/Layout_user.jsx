      ...
      <div className="flex justify-between text-center items-center ml-8 mr-8 mt-3">
        ...
        <div className="h-10 w-10 border-1 rounded-full bg-red-600 items-center text-center">
          <div className="relative">
            <span className="absolute left-5 right-5 top-5"><CiCircleChevDown  size={25}/></span>
            <span className="absolute left-5 right-5 top-5"><CiCircleChevUp size={25}/></span>
            <div className="relative">
            <span className="absolute left-[0.25rem] top-5"><User_popup/></span>
            </div>
