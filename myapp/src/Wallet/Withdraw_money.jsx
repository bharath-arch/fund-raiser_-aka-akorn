  ...
  return (
    <div className="  w-96 h-96 border-2 p-3 bg-white">
      ...
      <div className="mt-2 flex justify-center w-full">
        ...
        <div className="flex ">
          <span className="mr-5">+200</span>
          <span className="mr-5">+400</span>
          <span className="mr-5">+600</span>
        </div>
        ...
        <div className="relative">
            <button className="absolute top-[5.75rem] left-[16rem] border bg-blue-700 text-white px-8 py-1 font-arima rounded-lg ">
                pay
            </button>
        </div>
      </div>
